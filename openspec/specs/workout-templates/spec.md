...
## Purpose
Defines the team-curated Template catalog (program/workout/exercise templates + default schedule), listing available Templates, and adoption = a one-time clone into a new user-owned active Program with no propagation.
