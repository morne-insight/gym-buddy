# exercise-media-display Specification

## Purpose
Defines how the agent pushes exercise demonstration media (GIFs) to the mobile client over the data channel, how the mobile app displays the GIF on demand, and the data channel message format used for exercise media.
